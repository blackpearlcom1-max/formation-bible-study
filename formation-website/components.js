...
<footer class="w-full border-t border-[#f2e5f0]/10 bg-[#3D1540]">
  <div class="max-w-7xl mx-auto px-8 py-16">
    ...
    <div class="pt-6 text-center">
      <a href="https://sellwithboost.com/startups/formation-bible-study" target="_blank" rel="noopener noreferrer"><img src="https://sellwithboost.com/badge/formation-bible-study.svg" alt="Listed on Sell With boost" style="height:40px;width:auto;display:inline-block;opacity:0.7;"></a>
    </div>
  </div>
</footer>`;
