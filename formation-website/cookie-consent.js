...
(function () {
  ...
  function showBanner() {
    ...
    el.innerHTML =
      '<p>We use cookies to run Formation Bible Study and, with your consent, to understand how the app is used. Essential cookies (login, security) are always on. See our <a href="/cookie_policy.html">Cookie Policy</a>.</p>' +
      '<div id="fbs-cookie-actions">' +
        '<button id="fbs-cookie-reject" type="button">Reject non-essential</button>' +
